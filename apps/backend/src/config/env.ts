...
const parsed = envSchema.parse({
  ...
  DATABASE_URL:
    process.env.DATABASE_URL ?? "postgresql://postgres:postgres@localhost:5432/reachinbox",
  ...
  SLACK_NOTIFICATION_CHANNEL: process.env.SLACK_NOTIFICATION_CHANNEL ?? "#general",
...
export const env = {
  ...
  GOOGLE_CONFIGURED: Boolean(parsed.GOOGLE_CLIENT_ID && parsed.GOOGLE_CLIENT_SECRET),
  SLACK_CONFIGURED: Boolean(parsed.SLACK_CLIENT_ID && parsed.SLACK_CLIENT_SECRET),
